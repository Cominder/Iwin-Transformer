...
Follow [Swin](https://github.com/microsoft/Swin-Transformer/blob/main/get_started.md), We use standard ImageNet dataset, you can download it from http://image-net.org/. We provide the following two ways to
load data:
