# --------------------------------------------------------
# Iwin Transformer, refer Swin Transformer
# --------------------------------------------------------'
...
_C.MODEL.TYPE = 'iwin'
# Model name
_C.MODEL.NAME = 'iwin_tiny_patch4_window7_224'
...
# Iwin Transformer parameters
_C.MODEL.IWIN = CN()
_C.MODEL.IWIN.PATCH_SIZE = 4
_C.MODEL.IWIN.IN_CHANS = 3
_C.MODEL.IWIN.EMBED_DIM = 96
_C.MODEL.IWIN.DEPTHS = [4, 3, 2, 2]
_C.MODEL.IWIN.NUM_HEADS = [3, 6, 12, 24]
_C.MODEL.IWIN.WINDOW_SIZE = 7
_C.MODEL.IWIN.MLP_RATIO = 4.
_C.MODEL.IWIN.QKV_BIAS = True
_C.MODEL.IWIN.QK_SCALE = None
_C.MODEL.IWIN.APE = False
_C.MODEL.IWIN.PATCH_NORM = True
