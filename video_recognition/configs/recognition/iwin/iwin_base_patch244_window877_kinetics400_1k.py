...
model=dict(backbone=dict(patch_size=(2,4,4), window_size=(8,7,7), drop_path_rate=0.3), test_cfg=dict(max_testing_views=4))
...
work_dir = './work_dirs/k400_iwin_base_patch244_window877.py'
