...
class IwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, window_size=7, 
                 ...
                 act_layer=nn.GELU, norm_layer=nn.LayerNorm,  qk_scale=None, use_dwconv=True):
        super().__init__()
        self.dim = dim
        self.num_heads = num_heads
        ...
        self.attn = WindowAttention(
            ...
            attn_drop=attn_drop, proj_drop=drop, qk_scale=qk_scale)
    ...
    def forward(self, x):
        ...
        if self.dwconv is not None:
            xconv = x.permute(0, 3, 1, 2).contiguous()
            xconv = self.dwconv(xconv).permute(0, 2, 3, 1)             # B H W C
        ...
        x = rearrange(x, Hp // self.window_size, Wp // self.window_size)
        ...
        x = restore(x, Hp // self.window_size, Wp // self.window_size)  # B H' W' C
...
class IwinTransformer(nn.Module):
    ...
    def train(self, mode=True):
        ...
        super(IwinTransformer, self).train(mode)
        self._freeze_stages()
